...
export declare function gradeAtLeast(actual: Grade, floor: Grade): boolean;
/**
...
export declare const LIQUIDITY_ORDER: readonly LiquidityTier[];
 ...
 */
export type Rejection = "unpriced" | "below-grade-floor" | "fee-exceeds-principal";
